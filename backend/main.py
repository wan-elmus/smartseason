...
from routers import auth_router, fields_router, updates_router, dashboard_router, ai_router, upload_router, users_router, trends_router
...
app.include_router(trends_router, prefix="/v4", tags=["Trends"])
